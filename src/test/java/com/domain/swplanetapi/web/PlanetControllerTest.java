package com.domain.swplanetapi.web;

import com.domain.swplanetapi.controller.PlanetController;
...
public class PlanetControllerTest {
    ...
    public void createPlanet_WithValidData_ReturnsCreated() throws Exception {
        when(service.save(PLANET)).thenReturn(PLANET);
    ...
    public void createPlanet_WithInvalidData_ReturnsBadRequest() throws Exception{
        ...
        mockMvc.perform(post("/planets").content(objectMapper.writeValueAsString(empyPlanet))
    ...
    public void getPlanet_ByUnexistingName_ReturnsNotFound() throws Exception{
        mockMvc.perform(get("/planets/name/planet"))
                .andExpect(status().isNotFound());
    }
    ...
    public void listPlanets_ReturnsFilteredPlanets() throws Exception {
        ...
        mockMvc
                .perform(
                        get("/planets?" + String.format("terrain=%s&climate=%s",
                                TATOOINE.getTerrain(), TATOOINE.getClimate())))
                .andExpect(status().isOk())
